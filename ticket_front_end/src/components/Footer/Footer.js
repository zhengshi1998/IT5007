            ...
            <div>
                <div className="footer row">
                    <div className="footerIntro offset-2 col-2">
                        <h3>About us</h3>
                        "A national ticket booking system with over 80 years experiences which has already serverd
                        over 200,000,000 visitors.<br/>
                        Our mission is to make your trip easier!
                    </div>

                    <div className="footerContact offset-1 col-3">
                        <ul className="footerContact ">
                            <h4>Contact us via: </h4>
                            <li><span>Tel:</span>  8888 8888</li>
                            <li><span>Email:</span>  ticketBook@gmail.com</li>
